# META-PRD: Template for Generating Product Requirements Documents

> **Note**: This is a meta-template used by Phase 1 (rlm-discover) to generate project-specific PRDs. It is NOT the project's actual PRD — that will be generated at `RLM/specs/PRD.md` when you run the discovery phase.
