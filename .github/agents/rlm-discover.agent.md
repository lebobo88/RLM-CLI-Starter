...
If you are analyzing an existing codebase to generate this PRD, use the `@gemini-analyzer` agent to perform a deep analysis of the current code. Example: `@gemini-analyzer Analyze the current authentication flow and data models for the PRD.`
