...
# RLM Debug Agent — Diagnostics & Repair
...
- [✗] Missing: RLM/specs/design/ (created)

## State Files
- [✓] status.json: valid
- [✗] checkpoint.json: missing (rebuilt from tasks)
- [✓] pipeline-state.json: valid

## Cross-Reference
- [✓] All tasks reference valid features
- [✗] TASK-005 references FTR-003 but spec not found
- [✓] No orphaned tasks

## Consistency
- [✓] status.json matches file system
- [✗] TASK-002 in active/ but status says completed (fixed)
