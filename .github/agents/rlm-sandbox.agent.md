...
For implementation tasks that should run in sandbox:
- Delegate to `@rlm-implement` with sandbox context (sandbox ID, workspace path)

For verification tasks in sandbox:
- Delegate to `@rlm-verify` with sandbox URL and verification artifacts path
