---
name: sandbox
description: Guide for managing E2B/Docker sandbox environments for isolated code execution.
---
...
Use the `@rlm-sandbox` agent for full sandbox lifecycle management.
